...
import { CeramicApi, DocNext, DocOpts, DocState, Doctype } from '@ceramicnetwork/common';
 ...
 */
export async function validateState(state: DocState | DocNext, content: any, loadDocument: LoadDocumentFunc): Promise<void> {
